...
const TEST_CONFIG = {
  // Лимиты для запросов
  FIRST_REQUEST_LIMIT: 50,        // Сколько строк загрузить в первом запросе (для анализа структуры)
  BIG_REQUEST_LIMIT: 1,         // Сколько строк загрузить во втором запросе (для проверки объема данных)
